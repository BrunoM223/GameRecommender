...
class Model(metaclass=ABCMeta):
    ...
    @classmethod
    def find_random(cls, k: int) -> List[T]:
        return [cls(**elem) for elem in Database.get_random(cls.collection, k)]

    @classmethod
    def find_by_text(cls, t: str) -> List[T]:
        return[cls(**elem) for elem in Database.find_text(cls.collection, t)]
